...
if(is_post_request() && request_is_same_domain()) {
  ...
  if(isset($_POST['prev_password'])) { $user['prev_password'] = $_POST['prev_password']; }
...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo h(u($user['id'])); ?>" method="post">
    ...
    <input type="password" name="prev_password" /><br />
    Password:<br />
    ...
    <p>Strong password suggestion: <?php echo generate_strong_password(12); ?></p>
    <br />
